...
class CrashLogScreen(Screen):
    ...
    def CfgMenu(self):
        self.list = []
        if crashlogPath:
            crashfiles = os.popen("ls -lh %s*crash*.log %slogs/*crash*.log /home/root/*crash*.log /home/root/logs/*crash*.log %stwisted.log /media/usb/logs/*crash*.log" % (path_folder_log, path_folder_log, path_folder_log))
            sz_w = getDesktop(0).size().width()
            # if sz_w == 2560:
    ...
    def BlueKey(self):
        try:
            os.system("rm %s*crash*.log rm %slogs/*crash*.log /home/root/*crash*.log /home/root/logs/*crash*.log %stwisted.log /media/usb/logs/*crash*.log" % (path_folder_log, path_folder_log, path_folder_log))
